# Importing the Hunter Green Home Data

rm(list=ls())
library(readxl)
master.dataset = read_excel("Hunter Green Home Sales Dataset.xlsx")

# Data Preprocessing
# Converting all column names to lower case, to achieve consistency
...
#Excluding irrelevant variables from the analysis
...
#Building Polynomial Regression model for predicting Agent Days on Market(adom) 
...
# Building Polynomial Regression models for predcting house proce sold
